...
const Profile = () => {
  ...
  return (
    <div className="pt-8 h-screen bg-gradient-to-r from-[#f0e4e4] to-[#bdd6f2]">
        ...
        <div className="flex flex-col gap-10 md:gap-20 p-2 sm:p-4 md:p-8 w-full">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <section className="flex items-center justify-center mb-4 md:mb-0">
              <Avatar className="h-24 w-24 sm:h-38 sm:w-38">
                <AvatarImage
                  ...
                  {isLoggedInUserProfile ? (
                    <>
                      <Link to="/account/edit">
                        <Button
                          variant="secondary"
                          className="cursor-pointer bg-[#101e50] text-white hover:bg-gray-400 hover:text-black h-8 text-xs sm:text-sm"
                        >
                          Update profile
                        </Button>
                      </Link>
          ...
          <div className="border-t border-t-[#b5bdca] ">
                ...
                return (
                  <div key={post?._id} className="relative group cursor-pointer ">
                    <img
                      src={post.image}
                      alt="postimage"
                      className="rounded-sm mt-2 w-full aspect-square object-cover"
                    />
