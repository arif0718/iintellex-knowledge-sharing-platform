...
const EditProfile = () => {
    ...
    return (
        <div className='h-screen bg-gradient-to-r from-[#f0e4e4] to-[#bdd6f2]'>
            ...
            <div className='flex max-w-2xl mx-auto p-4 '>
                <section className='flex flex-col gap-6 w-full my-8'>
                    ...
                    <div>
                        ...
                        <Textarea value={input.bio} onChange={(e) => setInput({ ...input, bio: e.target.value })} name='bio' className="focus-visible:ring-transparent bg-gray-100" />
                    </div>
                    <div>
                            ...
                            loading ? (
                                ...
                                <Button
                                    disabled={
                                        ...
                                        input.profilePhoto === user?.profilePicture
                                    }
